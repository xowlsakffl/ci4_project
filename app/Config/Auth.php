...
class Auth extends ShieldAuth
{
    ...
    public array $passwordValidators = [
        ...
        'CodeIgniter\Shield\Authentication\Passwords\DictionaryValidator',//로컬파일 자주 유출되는 비번 비교
        // 'CodeIgniter\Shield\Authentication\Passwords\PwnedValidator',//외부사이트 자주 유출되는 비번 비교
    ];
